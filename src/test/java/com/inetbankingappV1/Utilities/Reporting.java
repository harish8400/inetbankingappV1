package com.inetbankingappV1.Utilities;
...
public class Reporting extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		extent.setSystemInfo("Host name","DESKTOP-829SJ9A");
		extent.setSystemInfo("Environemnt","QA");
		extent.setSystemInfo("user","HarishKumar");
	}
		public static void chartVisibilityOnOpen(boolean chartVisibilityOnOpen) {
			htmlReporter.config().setChartVisibilityOnOpen(chartVisibilityOnOpen);
